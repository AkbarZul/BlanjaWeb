        ...
        return (
            <>
                ...
                <div className="container">
                    <h1 style={{textAlign: 'center', fontWeight: 'bold'}}>Tambah Product Baru</h1>
                    ...
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control type="text"  name="product_brand" placeholder="Brand"  onChange={this.handlerChange}  />
                    </Form.Group>
                    <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Group controlId="formBasicEmail">
                        ...
                        <Form.Control type="number" name="product_size" placeholder="Product Size"  onChange={this.handlerChange}  />
                    </Form.Group>
                    <Form.Group controlId="formBasicEmail">
